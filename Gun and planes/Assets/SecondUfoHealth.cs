...
public class SecondUfoHealth : MonoBehaviour {
    [HideInInspector]
    public bool hit;
    [SerializeField]
    ...
    void TakeDamage(int damage)
    {
        ...
        if (_Health == 0)
        {
            ...
            audiomanager.StopSound("UfoLaser2");
            audiomanager.PlaySound("UfoDeath");
            myGold.GoldSalary(15);
    ...
    void Update()
    {
        ...
        if (hit == true)
        {
            showMyDamage = BarrelStats.damage;
